...
public sealed class OwnListsTests
{
    ...
    public void ItchZoneIsBackInTheList()
    {
        ...
        // Это раздача файлов и картинок самого itch.io: страницы приходят
        // с itch.io, обложки и сборки — с img.itch.zone.
        //
        // В отчёт проверки он с 2026-09-07 не идёт — по решению владельца,
        // у которого он работает. Но это про показ, а список задаёт маршрут:
        // выбросив имя отсюда, мы бы сломали картинки ради тишины в отчёте.
        // Тест сторожит именно эту разницу.
