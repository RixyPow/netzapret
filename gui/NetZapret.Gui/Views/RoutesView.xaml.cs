...
public partial class RoutesView : UserControl
{
    ...
    private string Describe(ServiceRouting.PartStatus part)
    {
        ...
        // Ни секции, ни рецепта в ней — winws2 имя не трогает, и по факту
        // оно идёт напрямую. Так и пишем: прежнее «десинк: пресет не чинит»
        // читалось как вид десинка, и владелец 23.09 спросил, не врёт ли
