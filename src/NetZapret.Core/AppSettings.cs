...
public sealed record AppSettings
{
    ...
    /// <remarks>
    /// <para>
    /// По умолчанию — Universal V7: он идёт в сборке и покрывает больше всего
    ...
    /// </para>
    /// <para>
    /// Был V6, стал V7: тот же набор плюс три правки по данным проверки —
    /// у Steam появился рецепт против обрыва потока после классификации,
    /// SoundCloud переведён на основной рецепт провайдера. Обе поломки мы
    /// разбирали, обе лечатся именно здесь.
    /// </para>
    /// <para>
    ...
    public const string DefaultPresetName = "Universal V7";
