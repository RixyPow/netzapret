...
public sealed record AppSettings
{
    ...
    /// <summary>Шрифт интерфейса поверх темы; <c>null</c> — как в теме.</summary>
    /// <remarks>
    /// Владелец, 24.09: «добавь настройки шрифта, размер текста, сам шрифт».
    /// Шрифт данных (адреса, задержки) не меняется намеренно: цифры
    /// в таблицах должны стоять столбиком, а это умеют только моноширинные.
    /// </remarks>
    public string? UiFont { get; init; }

    /// <summary>Шрифт заголовков вкладок поверх темы; <c>null</c> — как в теме.</summary>
