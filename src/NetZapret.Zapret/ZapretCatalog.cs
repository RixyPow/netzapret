...
/// </para>
/// <para>
/// Адреса отсюда попадают в hosts только пином — по выбору человека в окне
/// пина, после живой проверки (PinPicker), и в наш собственный блок файла.
/// Прежде здесь стояло «в hosts не пишем, отдаём своим резолвером»: так
/// было до пинов, и своего резолвера с подстановкой больше нет.
/// </para>
/// </remarks>
